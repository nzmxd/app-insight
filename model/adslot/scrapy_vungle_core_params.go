...
type ScrapyVungleCoreParams struct {
...
// TableName 表名称
func (s *ScrapyVungleCoreParams) TableName() string {
	return "scrapy_vungle_core_params"
}

func (s *ScrapyVungleCoreParams) Platform() string {
	return "vungle"
}

func (s *ScrapyVungleCoreParams) SetParamsDictMd5(md5 string) {
	s.ParamsDictMd5 = md5
}

func (s *ScrapyVungleCoreParams) GetParamsDictMd5() (string, error) {
	if s.ParamsDictMd5 != "" {
...
func (s *ScrapyVungleCoreParams) ValidateCoreParams() bool {
	s.IsAvailable = 1
	return true
}

func (s *ScrapyVungleCoreParams) GetAdUnitPushLog() *AdSlotPushLog {
