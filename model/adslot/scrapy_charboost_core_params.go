...
// ScrapyChartboostCoreParams undefined
type ScrapyChartboostCoreParams struct {
...
// TableName 表名称
func (s *ScrapyChartboostCoreParams) TableName() string {
	return "scrapy_chartboost_core_params"
}

func (s *ScrapyChartboostCoreParams) Platform() string {
	return "charboost"
}

func (s *ScrapyChartboostCoreParams) SetParamsDictMd5(md5 string) {
	s.ParamsDictMd5 = md5
}

func (s *ScrapyChartboostCoreParams) GetParamsDictMd5() (string, error) {
	if s.ParamsDictMd5 != "" {
...
func (s *ScrapyChartboostCoreParams) ValidateCoreParams() bool {
	s.IsAvailable = 1
	return true
}

func (s *ScrapyChartboostCoreParams) GetAdUnitPushLog() *AdSlotPushLog {
